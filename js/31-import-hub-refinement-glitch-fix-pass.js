/* Study Hive  -  file 31: import-hub-refinement-glitch-fix-pass
...
(function(){
  ...
  function cardsFromText(text, subject){
    ...
    parts.forEach(function(s,i){ cards.push({front:'What is the key idea in note '+(i+1)+'?', back:s, subject:subject||'Imported Notes', known:false}); });
